...
public class BarChart03View extends DemoView implements Runnable {
	...
	// 轴数据源
	public List<String> chartLabels = new LinkedList<String>();
	public List<BarData> chartData = new LinkedList<BarData>();
	public List<CustomLineData> mCustomLineDataset = new LinkedList<CustomLineData>();
	...
	private void chartRender() {
		try {
			...
			chart.setPadding(DensityUtil.dip2px(getContext(), 20),
					DensityUtil.dip2px(getContext(), 10), right, right);
			...
			// 图例
			chart.getAxisTitle().getLeftTitlePaint().setTextSize(30);
			chart.getAxisTitle().getLowerTitlePaint().setTextSize(30);
			chart.getAxisTitle().setTitleStyle(XEnum.AxisTitleStyle.ENDPOINT);
			// chart.getAxisTitle().setLeftTitle("所占百分比");
			chart.getAxisTitle().setLowerTitle("类别");
			...
			// 在柱形顶部显示值
			chart.getBar().getBarPaint().setTextSize(30);
			...
			chart.setItemLabelFormatter(new IFormatterDoubleCallBack() {
				...
				public String doubleFormatter(Double value) {
					...
					if(String.valueOf(value).equals("100.0")){
