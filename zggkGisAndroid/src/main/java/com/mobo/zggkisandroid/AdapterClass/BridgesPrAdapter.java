...
public class BridgesPrAdapter extends BaseAdapter {

	private ArrayList<BridgeMarksInfo> bridgeMarksInfos;
	private LayoutInflater inflater;

	public BridgesPrAdapter(Context context,
			ArrayList<BridgeMarksInfo> bridgeMarksInfos) {

		this.bridgeMarksInfos = bridgeMarksInfos;
	...
	public int getCount() {
		...
		return bridgeMarksInfos.size();
	}

	@Override
	public Object getItem(int position) {
		// TODO Auto-generated method stub
		return bridgeMarksInfos.get(position);
	}
...
//					.findViewById(R.id.bridge_belong_roadstation_txt);
		...
		mHolder.bridgeName.setText(bridgeMarksInfos.get(position)
				.getArea_name());
		mHolder.bridgeBelongRoadCode.setText("数量；"+bridgeMarksInfos.get(position)
				.getBridge_number());
//		mHolder.bridgeBelongRoadName.setText(bridgeMarksInfos.get(position)
//				.getRoad_name());
//		mHolder.bridgeStation.setText(changeStationToStandard(bridgeMarksInfos.get(position)
